...
public class SendMailHD extends javax.swing.JFrame {

    /**
     * Creates new form SendMailHD
     */
    public SendMailHD() {
        initComponents();
    }
 String duongDan = "";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SendMailHD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SendMailHD().setVisible(true);
            }
        });
    }
