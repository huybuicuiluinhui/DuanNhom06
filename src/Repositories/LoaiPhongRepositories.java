    ...
    public ArrayList<QLLoaiPhong> getOne(String tenLP) {
      ...
      try ( Connection con = DBConnection.getConnection();  PreparedStatement ps = con.prepareStatement(sql);) {
            ...
            ResultSet rs = ps.executeQuery();
             ...
             ArrayList<QLLoaiPhong> list = new ArrayList<>();
            while (rs.next()) {
                QLLoaiPhong ctSanPham = new QLLoaiPhong();
                ctSanPham.setMaLP(rs.getString(1));
                ctSanPham.setMoTa(rs.getString(2));
                ctSanPham.setTrangThai(rs.getInt(3));
                ctSanPham.setTenLP(tenLP);
